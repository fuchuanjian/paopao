...
#include "com_chuanonly_bubble_core_PlayerThread.h"
...
JNIEXPORT jboolean JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1Init
...
/*
 * Class:     com_chuanonly_bubble_core_PlayerThread
 * Method:    ModPlug_JLoad
 * Signature: ([BI)Z
 */
JNIEXPORT jboolean JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1JLoad
 ...
 */
JNIEXPORT jstring JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1JGetName
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1JNumChannels
  (JNIEnv *env, jobject obj)
{
  jint numchannels;
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1GetCurrentPos
  (JNIEnv *, jobject)
{
	  jint curr;
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1GetCurrentOrder
  (JNIEnv *env, jobject obj)
{
	  jint curr;
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1GetCurrentPattern
  (JNIEnv *env, jobject obj)
{
	  jint curr;
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1GetCurrentRow
  (JNIEnv *env, jobject obj)
{
	  jint curr;
 ...
 * Signature: ([SI)I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1JGetSoundData
 ...
 * Signature: ([BI)Z
 */
JNIEXPORT jboolean JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1JUnload
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1CloseDown
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1GetNativeTempo
  (JNIEnv *env, jclass cls)
{
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1ChangeTempo
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1SetTempo
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1ChangePattern
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1RepeatPattern
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1CheckPatternChange
  (JNIEnv *env, jclass cls)
{
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1SetPatternLoopMode
 ...
 * Signature: (III)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1SetPatternLoopRange
  (JNIEnv *env, jclass cls, jint from, jint to, jint when)
{
	...
	switch(when) {
	case com_chuanonly_bubble_core_PlayerThread_PATTERN_CHANGE_IMMEDIATE:
		...
		break;
	case com_chuanonly_bubble_core_PlayerThread_PATTERN_CHANGE_AFTER_CURRENT:
		...
		break;
	case com_chuanonly_bubble_core_PlayerThread_PATTERN_CHANGE_AFTER_GROUP:
	default:
		break;
	}
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1SetCurrentPattern
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1SetNextPattern
  (JNIEnv *env, jobject obj, jint pattern)
{
	ANDMODPLUGnextpattern = pattern;
	ANDMODPLUGnextpatternmode = 0;
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1LogOutput
  (JNIEnv *env, jclass cls, jboolean flag)
{
	if (flag == JNI_TRUE)
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_chuanonly_bubble_core_PlayerThread_ModPlug_1SetLoopCount
